...
var defaults = {
  'error_page_root': '~/sysdocs',
  'html/default_type': 'text/plain'
};

module.exports = {
  init: function(engine) {
    var config = engine.config;
    var basePath = config.data('base_path');
    //TODO: more robust handling of defaults;
    config.data('error_page_root', defaults.error_page_root.replace(/^~\//, basePath));
